...
export default function CreateExpenseForm() {
    ...
    const getSubDepartments = () => {
        return departmentStructure[form.department] || [];
    };
    ...
    const handleSubmit = async (e) => {
        ...
        // Validate sub-department if department has sub-departments
                    ...
                    <Stack spacing={3}>
                        ...
                        >
                            <TextField
                                ...
                                InputProps={{
                                    startAdornment: (
                                        <Typography color="text.secondary" sx={{ mr: 1, fontWeight: 500 }}>
                                            ₹
                                        </Typography>
                                    ),
                                }}
                        ...
                        {/* Sub-Department - Shows below department when department is selected */}
                        ...
                        <Card
                            ...
                            sx={{
                                ...
                                backgroundColor: form.proof ? 'success.lightest' : 'primary.lightest',
                                borderRadius: 3,
                                cursor: 'pointer',
                                transition: 'all 0.3s ease',
                                '&:hover': {
                                    borderColor: form.proof ? 'success.dark' : 'primary.main',
                                    backgroundColor: form.proof ? 'success.50' : 'primary.50',
                                }
                            }}
                        >
                        ...
                        {/* Validation Message - Changed to red color */}
                        {!form.proof && (
                            <Alert severity="error" sx={{ borderRadius: 2, border: '1px solid #f44336' }}>
                                ❌ Bill proof is required to create an expense
                            </Alert>
                        )}
                        ...
                        <Button
                            ...
                            size="medium"
                            sx={{
                                background: (form.proof && (!showSubDepartment || form.subDepartment))
                                ...
                                transition: 'all 0.3s ease',
                                '&:hover': (form.proof && (!showSubDepartment || form.subDepartment)) ? {
